...
func processFlags() *daemon.Config {
	...
	flag.StringVar(&cfg.Db.ConnectString, "db-connect", "host=localhost port=5432 user=postgres password=postgres dbname=postgres sslmode=disable", "DB Connect String")
